...
For the official Tailor Platform documentation, see [Executor Guide](/guides/executor/overview).
...
Trigger workflows from executors. See [Workflow documentation](workflow) for how to define workflows.
