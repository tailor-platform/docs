...
- PGlite runs full PostgreSQL, while TailorDB supports [a subset of it](/guides/function/accessing-tailordb#supported-sql-queries) — a statement that passes here can still be rejected on deploy.
